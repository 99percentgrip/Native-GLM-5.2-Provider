...
To pin a release, set `GLM_ACP_VERSION=v2.0.1` before running the Unix
installer, or pass `-Version v2.0.1` to the downloaded PowerShell script.
The current release and manual-download fallback is
[v2.0.1](https://github.com/99percentgrip/Native-GLM-ACP/releases/tag/v2.0.1).
...
# expect: glm_acp-2.0.1.dist-info  (and editable-install metadata)
```
