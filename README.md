...
To pin a release, set `GLM_ACP_VERSION=v1.9.4` before running the Unix
installer, or pass `-Version v1.9.4` to the downloaded PowerShell script.
The current release and manual-download fallback is
[v1.9.4](https://github.com/99percentgrip/Native-GLM-ACP/releases/tag/v1.9.4).
...
# expect: glm_acp-1.9.4.dist-info  (and editable-install metadata)
```
